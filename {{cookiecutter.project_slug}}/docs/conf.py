...
from {{ cookiecutter.project_slug }} import __copyright__, __packagename__, __version__
...
exclude_patterns = [
    ...
    "Thumbs.db",
    ".DS_Store",
    "api/{{ cookiecutter.project_slug }}.rst",
]
...
man_pages = [(master_doc, "{{ cookiecutter.project_slug }}", "{{ cookiecutter.name }} Documentation", [author], 1)]
...
apidoc_module_dir = "../src/{{ cookiecutter.project_slug }}" ### ToDO: change if not inside src
